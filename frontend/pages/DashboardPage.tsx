          ...
          <div className="flex-1 overflow-auto custom-scrollbar">
            ...
            {isLoading ? (
                <div className="space-y-4 p-4">
                    <div className="h-8 bg-slate-50 rounded-lg animate-pulse w-full"></div>
                    <div className="h-8 bg-slate-50 rounded-lg animate-pulse w-full"></div>
                    <div className="h-8 bg-slate-50 rounded-lg animate-pulse w-full"></div>
                    <div className="h-8 bg-slate-50 rounded-lg animate-pulse w-full"></div>
                </div>
                ...
                <tbody className="divide-y divide-slate-50">
                    ...
                    <tr key={sale.id} className="hover:bg-slate-50 transition-colors">
                        ...
                        <div className="text-xs text-slate-400 font-medium">{new Date(sale.created_at).toLocaleTimeString([], {hour:'2-digit', minute:'2-digit'})}</div>
                        </td>
                        <td className="p-3 align-top">
                        ...
                        <span className={`inline-flex items-center gap-1 px-2 py-0.5 rounded text-[10px] font-bold border ${sale.payment_method === 'Yape' ? 'bg-purple-50 text-purple-700 border-purple-100' : 'bg-green-50 text-green-700 border-green-100'}`}>
                            {sale.payment_method}
                        </span>
                        </td>
                        <td className="p-3 align-top text-right font-bold text-slate-800 text-base">
